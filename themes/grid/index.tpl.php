    ...
    <body>
    <div id='wrapper' class='rounded-corner-bottom'>
<div id='outer-wrap-header'>
	<div id='inner-wrap-header'>
	  <div id='header'>
	     <div id='login-menu' class='rounded-corner-bottom-login'><?=login_menu()?></div>
	        <div id='banner'>
...
<div id='outer-wrap-footer' class='rounded-corner-bottom'>
