 ...
 */
 function create_url($urlOrController=null, $method=null, $arguments=null) {
  return Cninq::Instance()->CreateUrl($urlOrController, $method, $arguments);
}
 ...
 */
 function theme_url($url) {
  return create_url(Cninq::Instance()->themeUrl . "/{$url}");
}
 ...
 */
 function theme_parent_url($url) {
  return create_url(Cninq::Instance()->themeParentUrl . "/{$url}");
}
