...
/**
  * Properties
  */
  private $ninqCoreModules = array('Cninq', 'CDatabase', 'CRequest', 'CViewContainer', 'CSession', 'CObject');
  private $ninqCMFModules = array('CForm', 'CCPage', 'CCBlog', 'CMUser', 'CCUser', 'CMContent', 'CCContent', 'CFormUserLogin', 'CFormUserProfile', 'CFormUserCreate', 'CFormContent', 'CTextFilter');
  ...
  */
      private function GetDetailsOfModule($module) {
        ...
        if(class_exists($module)) {
          ...
          $details['isninqCore']    = in_array($rc->name, $this->ninqCoreModules);
          $details['isninqCMF']     = in_array($rc->name, $this->ninqCMFModules);
