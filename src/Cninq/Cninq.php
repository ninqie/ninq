...
/**
  ...
  */
  public function ThemeEngineRender() {
    ...
    $themePath    = NINQ_INSTALL_PATH . '/' . $this->config['theme']['path'];
    ...
    if(isset($this->config['theme']['parent'])) {
      $parentPath = NINQ_INSTALL_PATH . '/' . $this->config['theme']['parent'];
      $parentUrl  = $this->request->base_url . $this->config['theme']['parent'];
    }
    
    // Add stylesheet path to the $ninq->data array
    $this->data['stylesheet'] = $this->config['theme']['stylesheet'];
    
    // Make the theme urls available as part of $ninq
    ...
    // functions.php from the parent theme
    if($parentPath) {
    ...
    // Extract $ninq->data to own variables and handover to the template file
    extract($this->data); 
